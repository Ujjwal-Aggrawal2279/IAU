async function getUserFullName() {
    try {
        ...
        jobApplicants.forEach(job => {
            ...
            row.innerHTML = `
                <td><a href="${jobDetailsUrl}" style="color: #10142380 !important; font-size : 1.125rem">${job.job_title}</a></td>
                <td style="color: #10142380 !important; font-size : 1.125rem">${formatDate(job.creation)}</td>
                <td class="${statusClass}" style="color: #10142380 !important; font-size : 1.125rem">${statusText} <span class="status-dot"></span></td>
            `;
